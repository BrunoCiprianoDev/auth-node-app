...
describe('RoleController tests', () => {
    let mockedRoleUseCase: jest.Mocked<IRoleUseCase>;
    ...
    beforeAll(() => {
        ...
        roleController = new RoleController(mockedRoleUseCase);
        mockedHttpContext = {
            getRequest: jest.fn(),
            send: jest.fn(),
        };
    ...
    describe('Function FindById tests', () => {
        test('It should return a role by id with status code = 200', async () => {
            ...
            jest.spyOn(mockedRoleUseCase, 'findById').mockResolvedValue(serviceResponseExpected);
        ...
        test('Should return 404 when id is not provided', async () => {
            jest
                .spyOn(mockedRoleUseCase, 'findById')
        ...
        test('It should return InternalError when an unexpected error occurs', async () => {
            jest.spyOn(mockedRoleUseCase, 'findById').mockRejectedValue(new Error('Any string'));
    ...
    describe('Function FindAll tests', () => {
        test('It should return a list role with status code = 200', async () => {
            ...
            jest
                .spyOn(mockedRoleUseCase, 'findAll')
