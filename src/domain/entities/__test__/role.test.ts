...
describe('Role tests', () => {
    ...
    test('Should return Error create a user if the id does not match the pattern', () => {
        ...
        expect(() => new Role(roleData)).toThrow(new ValidationError(`The id entered does not match the uuid pattern`));
    ...
    test('It should return an error when trying to set an invalid id', () => {
        ...
        expect(() => role.id = 'anyString').toThrow(new ValidationError(`The id entered does not match the uuid pattern`));
    ...
    test('It should return an error if the name is empty', () => {
        ...
        expect(() => new Role(roleData)).toThrow(new ValidationError(`The value for 'name' must not be empty.`));
